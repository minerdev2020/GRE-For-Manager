...
import com.minerdev.greformanager.customadapter.SectionPageAdapter
import com.minerdev.greformanager.databinding.ActivityHouseModifyBinding
import com.minerdev.greformanager.fragment.ImageFragment
import com.minerdev.greformanager.fragment.InfoFragment1
import com.minerdev.greformanager.fragment.InfoFragment2
import com.minerdev.greformanager.fragment.InfoFragment3
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mode == "add") {
            ...
            viewModel.images.observe(this, { images: List<Image> ->
                for (image in images) {
                    image.state = Request.Method.PATCH
